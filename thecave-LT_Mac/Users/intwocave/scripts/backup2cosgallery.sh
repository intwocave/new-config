...
COMMON_OPTS_COSPLAY_SATSUEI=('--modify-window=1' '--exclude=._*' '--exclude=.fseventsd' '--exclude=.Spotlight-V100' '--exclude=.Trashes' '--exclude=.DS_Store' '--exclude=*~' '--iconv=utf-8-mac,utf-8')
...
case $value in
	1)
		...
		rsync -avhWPn "${COMMON_OPTS_COSPLAY_SATSUEI[@]}" "/Volumes/Clow - Data/Users/monakio/Downloads/코스프레촬영" 192.168.0.100:"/mnt/CosGallery/"
	...
	2)
		...
		rsync -avhWP "${COMMON_OPTS_COSPLAY_SATSUEI[@]}" "/Volumes/Clow - Data/Users/monakio/Downloads/코스프레촬영" 192.168.0.100:"/mnt/CosGallery/"
