...
sudo ffmpeg -f v4l2 -video_size 640x480 -framerate 25 -i /dev/video0 -f alsa -i hw:1,0 -c:v libx264 -preset ultrafast -tune zerolatency -c:a aac -b:a 128k -f rtsp rtsp://localhost:8554/cctv > /dev/null 2>&1 &
PID_FFMPEG=$!
